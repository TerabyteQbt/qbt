        ...
        return new Object() {
            public <M, B> int run(QbtManifestVersion<M, B> targetVersion) {
                ...
                for(RepoTip repo : repos.build()) {
                    ...
                    Optional<VcsVersionDigest> lhsVersion = lhsRepoManifest.___version;
                    Optional<VcsVersionDigest> mhsVersion = mhsRepoManifest.___version;
                    Optional<VcsVersionDigest> rhsVersion = rhsRepoManifest.___version;
