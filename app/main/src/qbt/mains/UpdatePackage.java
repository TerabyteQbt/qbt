...
public final class UpdatePackage extends QbtCommand<UpdatePackage.Options> {
    ...
    public static interface Options extends QbtCommandOptions {
        ...
        //public final OptionsFragment<Options, Maybe<Boolean>> archIndependent = o.zeroArg("archIndependent").transform(o.flag()).helpDesc("Package is architecture independent");
    ...
    public int run(final OptionsResults<? extends Options> options) throws IOException {
        ...
        if(prefix != null) {
            Maybe<String> newPrefix;
            if(prefix.equals("null")) {
                newPrefix = Maybe.not();
            }
            else {
                newPrefix = Maybe.of(prefix);
            }
            pmd = pmd.transform(PackageMetadata.PREFIX, (oldprefix) -> newPrefix);
        }
