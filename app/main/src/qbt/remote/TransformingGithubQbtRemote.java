...
public final class TransformingGithubQbtRemote implements QbtRemote {
    private static final Logger LOGGER = LoggerFactory.getLogger(TransformingGithubQbtRemote.class);
    ...
    public TransformingGithubQbtRemote(RawRemoteVcs vcs, Function<String, String> transformation, String authToken, String user) {
        this(vcs, transformation, authToken, user, "%r");
    }

    public TransformingGithubQbtRemote(RawRemoteVcs vcs, Function<String, String> transformation, String authToken, String user, String repo) {
        this.vcs = vcs;
    ...
    private String formatRepo(RepoTip repoTip) {
        return repo.replace("%r", transformation.apply(repoTip.name)).replace("%t", repoTip.tip);
    }
